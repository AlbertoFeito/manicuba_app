...
/// trae la app de fábrica para el rubro elegido. Se guardan en el
/// dispositivo (persisten entre arranques) y se combinan con
/// [BusinessConfig.categoriasProductos] al leer.
class CategoriaService {
  ...
  Future<List<String>> obtenerCategorias() async {
    ...
    final base = AppConfig.instance.current.categoriasProductos
        .where((c) => c != 'Otros')
        .toList();
  ...
  Future<void> agregarCategoria(String nombre) async {
    ...
    final yaExiste = custom.any((c) => c.toLowerCase() == limpio.toLowerCase()) ||
        AppConfig.instance.current.categoriasProductos
