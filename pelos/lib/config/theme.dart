...
class AppTheme {
  // Colores principales
  static const Color primaryColor = Color(0xFF6A1B9A); // Morado intenso
  static const Color primaryLight = Color(0xFFBA68C8); // Morado claro
  static const Color primaryDark = Color(0xFF4A148C); // Morado oscuro
