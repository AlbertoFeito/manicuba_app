    ...
    final servicios = [
      {
        ...
        'precio': 10.0,
        'duracion_minutos': 30,
        'descripcion': 'Corte y acabado a tu estilo'
      },
      {
        'nombre': 'Peinado',
        'precio': 15.0,
        'duracion_minutos': 45,
        'descripcion': 'Peinado para eventos y ocasiones'
      },
      {
        'nombre': 'Tinte / Color',
        'precio': 25.0,
      ...
      },
      {
        ...
        'descripcion': 'Mechas, balayage y matiz'
      },
      {
        'nombre': 'Tratamiento / Hidratación',
        'precio': 18.0,
        'duracion_minutos': 45,
        'descripcion': 'Hidratación y nutrición capilar'
      },
      {
        'nombre': 'Alisado / Keratina',
        'precio': 50.0,
        'duracion_minutos': 180,
        'descripcion': 'Alisado y tratamiento de keratina'
      },
    ];
