// Smoke test para la app PeluCuba.
//
...
import 'package:pelucuba_app/main.dart';
...
void main() {
  testWidgets('La app arranca en la pantalla de inicio',
    ...
    for (var i = 0;
        i < 10 &&
            find.text('¡Bienvenida a PeluCuba! 💇').evaluate().isEmpty;
        i++) {
      await tester.pump(const Duration(milliseconds: 50));
    }

    // El saludo de bienvenida está presente.
    expect(find.text('¡Bienvenida a PeluCuba! 💇'), findsOneWidget);
