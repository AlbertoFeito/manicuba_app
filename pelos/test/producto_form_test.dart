...
import 'package:pelucuba_app/models/producto.dart';
import 'package:pelucuba_app/screens/inventario/producto_form_screen.dart';
import 'package:pelucuba_app/services/inventario_service.dart';
  ...
  testWidgets('No deja crear un producto repetido en la misma categoría',
    ...
    await tester.runAsync(() async {
      ...
      fichas = (await inventario.obtenerTodos())
          .where((p) => p.nombre == nombre && p.categoria == 'Tintes')
          .length;
    });
