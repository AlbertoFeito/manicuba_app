...
import 'package:pelucuba_app/models/foto_trabajo.dart';
import 'package:pelucuba_app/models/post_redes.dart';
import 'package:pelucuba_app/screens/redes_sociales/post_form_screen.dart';
import 'package:pelucuba_app/services/compartir_service.dart';
import 'package:pelucuba_app/services/foto_service.dart';
import 'package:pelucuba_app/services/redes_service.dart';
...
void main() {
  ...
  test('CompartirService.archivosDePost descarta fotos borradas del disco',
      () async {
    final archivo = File(
      '${Directory.systemTemp.path}/pelucuba_test_${DateTime.now().microsecondsSinceEpoch}.jpg',
    );
