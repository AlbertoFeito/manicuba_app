# ManiCuba - App de Gestión de Manicura 💅

App móvil Flutter para gestionar negocio de manicura con sincronización offline-first.
...
- 🐛 Issues: [GitHub Issues](https://github.com/AlbertoFeito/manicuba-app/issues)
