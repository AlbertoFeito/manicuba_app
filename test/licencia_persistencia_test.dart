...
void main() {
  ...
  test('activar acepta el código correcto y queda licenciado', () async {
    ...
    final codigo = LicenciaService.computeLicence(id, _secretoDev);
